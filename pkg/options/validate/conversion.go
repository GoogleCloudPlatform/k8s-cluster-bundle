...
// TODO(kashomon): This package was copied wholesale from
// k8s.io/apiextensions-apiserver/pkg/apiserver/validation in 1.9, the
// Conversion method is private in this version. In later versions, it's
// public, but the cluster bundle still needs to use api machinery at 1.9.
// Once we upgrade to a later apimachinery version, this file can be deleted.

// ConvertJSONSchemaProps converts an apiextensions.JSONSchemaProps to a spec.Schem.
