...
// Conversion method was private in this version; in >=1.11, it's public. So,
// we could use this method, but it's currently a challenge to import a newer
// version of apiextensions-apiserver internally.
