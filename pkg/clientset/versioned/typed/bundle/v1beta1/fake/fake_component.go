...
type FakeComponents struct {
	Fake *FakeBundleV1beta1
	ns   string
}

var componentsResource = schema.GroupVersionResource{Group: "bundle.gke.io", Version: "v1beta1", Resource: "components"}

var componentsKind = schema.GroupVersionKind{Group: "bundle.gke.io", Version: "v1beta1", Kind: "Component"}
...
func (c *FakeComponents) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Component, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(componentsResource, c.ns, name, data, subresources...), &v1beta1.Component{})
