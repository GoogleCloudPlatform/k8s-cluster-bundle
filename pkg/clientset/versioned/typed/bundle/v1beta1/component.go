...
import (
	v1beta1 "github.com/GoogleCloudPlatform/k8s-cluster-bundle/pkg/apis/bundle/v1beta1"
...
type ComponentInterface interface {
	Create(*v1beta1.Component) (*v1beta1.Component, error)
	Update(*v1beta1.Component) (*v1beta1.Component, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.Component, error)
	List(opts v1.ListOptions) (*v1beta1.ComponentList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Component, err error)
	ComponentExpansion
}
...
func newComponents(c *BundleV1beta1Client, namespace string) *components {
	return &components{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *components) Get(name string, options v1.GetOptions) (result *v1beta1.Component, err error) {
	result = &v1beta1.Component{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("components").
		Name(name).
...
func (c *components) List(opts v1.ListOptions) (result *v1beta1.ComponentList, err error) {
	result = &v1beta1.ComponentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("components").
...
func (c *components) Create(component *v1beta1.Component) (result *v1beta1.Component, err error) {
	result = &v1beta1.Component{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("components").
...
func (c *components) Update(component *v1beta1.Component) (result *v1beta1.Component, err error) {
	result = &v1beta1.Component{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("components").
...
func (c *components) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Component, err error) {
	result = &v1beta1.Component{}
